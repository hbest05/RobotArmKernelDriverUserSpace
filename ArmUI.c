...
int main(int argc, char *argv[])
{
    ...
    int battery_status = 0; //petr connect battery pls
    ...
    const char *arm_connection_string = arm_connected ? "Arm status: connected" : "Arm status: unconnected";
    ...
    gboolean joystick_connected = FALSE;
    //update/check joystick connection
    const char *joystick_connection_string = joystick_connected ? "Joystick status: connected" : "Joystuck status: unconnected";
